...
document.querySelector(".p1").addEventListener("click", function () {
  c1++;
  if (c1 % 2 !== 0) return document.querySelector(".current").innerHTML = `Heat Waves Glass animals`,PlaySong(s1);
...
document.querySelector(".p2").addEventListener("click", function () {
  c2++;
  if (c2 % 2 !== 0) return document.querySelector(".current").innerHTML = `Sweater wheather X after dark`,PlaySong(s2);
...
document.querySelector(".p3").addEventListener("click", function () {
  c3++;
  if (c3 % 2 !== 0) return document.querySelector(".current").innerHTML = `Running up hill Totem Remix`,PlaySong(s3);
...
document.querySelector(".p4").addEventListener("click", function () {
  c4++;
  if (c4 % 2 !== 0) return document.querySelector(".current").innerHTML = `Fraco Dead To me`,PlaySong(s4);
...
document.querySelector(".p5").addEventListener("click", function () {
  c5++;
  if (c5 % 2 !== 0) return document.querySelector(".current").innerHTML = `Ghostamane Fed up`,PlaySong(s5);
...
document.querySelector(".p6").addEventListener("click", function () {
  c6++;
  if (c6 % 2 !== 0) return document.querySelector(".current").innerHTML = `Sia Unstoppable`,PlaySong(s6);
...
document.querySelector(".p7").addEventListener("click", function () {
  c7++;
  if (c7 % 2 !== 0) return document.querySelector(".current").innerHTML = `WeekEnd Blinding Lights`,PlaySong(s7);
...
document.querySelector(".p8").addEventListener("click", function () {
  c8++;
  if (c8 % 2 !== 0) return document.querySelector(".current").innerHTML = `Sia And Zayn Dusk Till Dawn`,PlaySong(s8);
...
document.querySelector(".p9").addEventListener("click", function () {
  c9++;
  if (c9 % 2 !== 0) return document.querySelector(".current").innerHTML = `Murder in my mind`,PlaySong(s9);
